namespace :seed do
  ...
  task :exercises => :environment do
    exercises = [
      ...
      { :name => "10x800", :time => 70, :untis => '["miles", "minutes"]', :instructions => "2 miles slow, 10 x 800 fast w/1min rest, 1 mile slow Fast is 7:05 - 7:20 pace per mile." },
      ...
      { :name => "Sprints", :time => 50, :untis => '["miles", "minutes"]', :instructions => "Fast pace is 9:50/mi to 10:00/mi.  Splitting up the run lets you run faster and maintain a tempo effort."}
